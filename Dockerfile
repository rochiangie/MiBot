...
function isTrigger(text) {
  ...
  return /^(hola|menu|menú|ayuda|hi|hello)$/.test(t);
}
    ...
    case 'menu_principal':
      switch (message) {
        ...
        case '5':
          ...
          return 'otros';
        default:
          // En menú principal, si no elige opción válida, no spameamos:
          await safeReply(msg, '😅 No entendí… elegí una opción (1 a 5) o escribí *menu*.');
          return 'menu_principal';
      }
